...
public class EdmAggregationDemonstrator {
	...
	static class Parameters {
		@Option(name = "-u", usage = "URL of the LDES stream", metaVar = "<URL>", required = true)
	...
	static class LdesHarvesterDemo {
		...
		public LdesHarvesterDemo(String streamUrl, String iiifManifestTimestampFile, String edmRepoFolder,
			...
			MetadataHarvester seeAlsoHarvester = new MetadataHarvester(new File(edmRepoFolder));
		...
		public void executeLdesCrawling() throws Exception {
			System.out.println("Processing LDES stream...");
			CrawlReport report = ldesCrawlAlgorithm.processStream(streamUrl);
	...
	public static void main(String[] args) throws Exception {
		...
		LdesHarvesterDemo demo = new LdesHarvesterDemo(params.streamUrl,
				params.timestampsDbFolder, params.edmRepositoryFolder, params.logFilePath);
		demo.executeLdesCrawling();
	}
}
